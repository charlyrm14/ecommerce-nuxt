...
<template>
    <footer class="fixed bottom-4 left-1/2 transform -translate-x-1/2 w-[60%] md:w-[30%] bg-black dark:bg-dark-light py-1 px-2 shadow-lg flex justify-between items-center z-50 rounded-4xl">
        ...
        <NuxtLink
            to="/favorites" 
            class="flex flex-col items-center py-2 px-4 text-white rounded-4xl cursor-pointer hover:opacity-75"
            :class="route.path === '/favorites' ? 'bg-red-500 ' : ''">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6 md:size-8">
        ...
        <NuxtLink
            to="/cart"
            class="flex flex-col items-center py-2 px-4 text-white rounded-4xl cursor-pointer hover:opacity-75"
            :class="route.path === '/cart' ? 'bg-red-500 ' : ''">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6 md:size-8">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 3h1.386c.51 0 .955.343 1.087.835l.383 1.437M7.5 14.25a3 3 0 0 0-3 3h15.75m-12.75-3h11.218c1.121-2.3 2.1-4.684 2.924-7.138a60.114 60.114 0 0 0-16.536-1.84M7.5 14.25 5.106 5.272M6 20.25a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0Zm12.75 0a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0Z" />
                </svg>
        </NuxtLink>
        <button class="flex flex-col items-center py-2 px-4 text-white rounded-4xl cursor-pointer hover:opacity-75">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6 md:size-8">
